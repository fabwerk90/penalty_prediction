...
class PenaltyScraperSpider(scrapy.Spider):
    name = 'missed_all_leagues'
    start_urls = country_and_year_urls


    def parse(self, response):
        matchday = response.xpath("//div[@class = 'responsive-table'][1]//table[@class = 'items']//td[@class = 'zentriert'][1]/text()").extract()
        penalty_taker = response.xpath("//div[@class = 'responsive-table'][1]//table[@class = 'items']//table[@class = 'inline-table']//td[@class = 'hauptlink']/a/@title").extract()
        penalty_taker_position = response.xpath("//div[@class = 'responsive-table'][1]//table[@class = 'items']//table[@class = 'inline-table']/tr[2]/td/text()").extract()
        penalty_taker_club = response.xpath("//div[@class = 'responsive-table'][1]//table[@class = 'items']//td[@class = 'zentriert no-border-rechts'][1]//a//img/@alt").extract()
        goalkeeper = response.xpath("//div[@class = 'responsive-table'][1]//table[@class = 'items']//td[@class = 'links hauptlink no-border-links']/a/@title").extract()
        score_before_penalty = response.xpath("//div[@class = 'responsive-table'][1]//table[@class = 'items']//td[@class = 'zentriert no-border-rechts no-border-links']/text()").extract()
        minute = response.xpath("//div[@class = 'responsive-table'][1]//table[@class = 'items']//td[@class = 'zentriert'][2]/text()").extract()
        home_team = response.xpath("//div[@class = 'responsive-table'][1]//td[@class = 'zentriert no-border-rechts'][3]/a/img/@alt").extract()
        away_team = response.xpath("//div[@class = 'responsive-table'][1]//td[@class = 'zentriert no-border-links']/a/img/@alt").extract()
        final_score = response.xpath("//div[@class = 'responsive-table'][1]//td[@class = 'zentriert no-border-rechts no-border-links']/a/span/text()").extract()
